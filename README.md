...
| create\_product\_group\_relationships | Create a relationship between groups and products. Lists for products and groups must be of the same size | `bool` | `false` | no |
...
| groups | List of groups to create | `list(string)` | `[]` | no |
...
| api\_management\_identity | The identity map of the APIM |
